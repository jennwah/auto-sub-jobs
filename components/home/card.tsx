  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-md text-center">
        <h2 className="bg-gradient-to-br text-[#1d9bf0] from-black to-stone-500 bg-clip-text font-display text-xl font-bold text-transparent md:text-3xl md:font-normal">
